...
<html lang="en">
    ...
    <head>
        <meta charset="utf-8" />
        <title>ALTERNATIVNE POLOZKY</title>
                    ...
                    <div class="page-sidebar navbar-collapse collapse">
                        ...
                        <ul class="page-sidebar-menu  page-header-fixed " data-keep-expanded="false" data-auto-scroll="true" data-slide-speed="200" style="padding-top: 20px">
                            ...
                            <li class="heading">
								...
								<li class="nav-item  ">
                                        <a href="?modul=pridat-alternativu" class="nav-link ">
                                            <span class="title">Pridat Alternativu</span>
                                        </a>
                                   </li>
								   <li class="nav-item  ">
                                        <a href="?modul=moduly" class="nav-link ">
                                            <span class="title">Pridat Moduly</span>
                                        </a>
                                   </li>
								   <li class="nav-item  ">
								   ...
								   <li class="nav-item  ">
                                        <a href="?modul=appka-mapa" class="nav-link ">
                                            <span class="title">MAPA</span>
                                        </a>
                                   </li>
								   <li class="nav-item  ">
                                        <a href="?modul=stroje" class="nav-link ">
                                            <span class="title">Stroje</span>
                                        </a>
                                   </li>
							...
							<li class="nav-item  ">
                                        <a href="?modul=alternativy" class="nav-link ">
                                            <span class="title">Alternativy</span>
                                        </a>
                                   </li>
								   <li class="nav-item  ">
                                        <a href="?modul=zaznamy-modulov" class="nav-link ">
                                            <span class="title">Moduly</span>
                                        </a>
                                   </li>
								   <li class="nav-item  ">
                                        <a href="?modul=statistika" class="nav-link ">
                                            <span class="title">Statistika</span>
                                        </a>
                                   </li>
								   <li class="nav-item  ">
                                        <a href="?modul=rebricky" class="nav-link ">
                                            <span class="title">Rebricky</span>
                                        </a>
                                   </li>
								   <li class="nav-item  ">
