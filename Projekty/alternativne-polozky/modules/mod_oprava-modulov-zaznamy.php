                                    ...
                                    <div class="portlet-body form">
                                        <form class="form-horizontal" role="form">
                                            <div class="form-body">
												...
												<input type="hidden" name="modul" value="oprava-modulov/zaznamy/export">
								...
								<div class="portlet box blue ">
                                    ...
                                    <div class="portlet-body form">
                                        <form class="form-horizontal" role="form">
                                            <div class="form-body">
                                                <div class="form-group">
												<input type="hidden" name="modul" value="oprava-modulov/zaznamy">
                                    ...
                                    <div class="portlet-body">
                                            ...
                                            <table class="table table-bordered">
                                               <thead>
												...
												$limit = 50;
												$url="?".$url_part."modul=oprava-modulov/zaznamy";
												$startpoint = ($page * $limit) - $limit;
												$c=$connect;
												
												if($user->isAdmin()){
													$statement = "oprava_modulov_zaznamy".$statement_part_a;
												}
												else{
													$statement = "oprava_modulov_zaznamy WHERE autor=".$_SESSION['user_id'].$statement_part_b;
												}
												...
												<tr>
														...
														<td> <?php echo $result_zaznamy['seriove_cislo']; ?></td>
														<td> <?php echo $result_zaznamy['chyba']; ?></td>
