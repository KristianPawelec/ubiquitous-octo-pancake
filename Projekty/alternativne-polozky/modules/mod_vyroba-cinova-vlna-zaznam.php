...
if(isset($_POST['submit'])){
	...
	$query_insert="INSERT INTO vyroba_cinova_vlna_zaznamy(cislo_modulu,vp,pocet,moduly_od_do,os_cislo,datum,autor) VALUES('".$_POST['modul']."','".$_POST['vp']."','".$_POST['pocet']."','".$_POST['moduly_od_do']."','".$_POST['os_cislo']."',NOW(),'".$autor."')";
                                    ...
                                    <div class="portlet-body">
                                       ...
                                       <form class="form-horizontal" role="form" method="POST" action="">
                                            <div class="form-body">
												...
												<div class="form-group">
                                                    <label class="col-md-3 control-label">Počet</label>
                                                    <div class="col-md-9">
												...
												<div class="form-group">
                                                    <label class="col-md-3 control-label">Č. modulov od-do</label>
                                                    <div class="col-md-9">
													
													<input class="form-control" size="16" type="text" placeholder="Č. modulov od-do" name="moduly_od_do" value=""  required="">
                                                        
													</div>
														
                                                </div>
												<div class="form-group">
                                                    <label class="col-md-3 control-label">Os.č.</label>
                                                    <div class="col-md-9">
													
													<input class="form-control" size="16" type="text" placeholder="Os. č." name="os_cislo" value=""  required="">
