<div class="page-content">
 ...
 $query_export="SELECT * FROM vyroba_osadzanie_smd_zaznamy WHERE datum>='".$datum_od."' AND DATE(datum)<='".$datum_do."'";
$apply_export=mysqli_query($connect,$query_export);
$csv_text="id;cislo_modulu;vp;pocet; datum;autor
";
...
while($result_export=mysqli_fetch_array($apply_export)){
	...
	$csv_text.=	$result_export['id'].";".$result_export['cislo_modulu'].";".$result_export['vp'].";".$result_export['pocet'].";".$result_export['datum'].";".$autor."
	";
