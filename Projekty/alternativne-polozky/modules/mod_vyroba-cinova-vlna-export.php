...
$query_export="SELECT * FROM vyroba_cinova_vlna_zaznamy WHERE datum>='".$datum_od."' AND DATE(datum)<='".$datum_do."'";
$apply_export=mysqli_query($connect,$query_export);
$csv_text="id;cislo_modulu;vp;pocet;moduly_od_do;osobne_cislo; datum;autor
";
...
while($result_export=mysqli_fetch_array($apply_export)){
	...
	$csv_text.=	$result_export['id'].";".$result_export['cislo_modulu'].";".$result_export['vp'].";".$result_export['pocet'].";".$result_export['moduly_od_do'].";".$result_export['os_cislo'].";".$result_export['datum'].";".$autor."
	";
