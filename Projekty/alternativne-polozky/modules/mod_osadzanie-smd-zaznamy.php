...
<div class="portlet box blue ">
                                    ...
                                    <div class="portlet-body form">
                                        <form class="form-horizontal" role="form">
                                            <div class="form-body">
												...
												<input type="hidden" name="modul" value="vyroba/osadzanie-smd/zaznamy/export ">
                                    ...
                                    <div class="portlet-body form">
                                        <form class="form-horizontal" role="form">
                                            <div class="form-body">
                                                <div class="form-group">
												<input type="hidden" name="modul" value="vyroba/osadzanie-smd/zaznamy">
                                    ...
                                    <div class="portlet-body">
                                            ...
                                            <table class="table table-bordered">
                                               <thead>
												...
												$limit = 50;
												$url="?".$url_part."modul=vyroba/osadzanie-smd/zaznamy";
												$startpoint = ($page * $limit) - $limit;
												$c=$connect;
												if($user->isAdmin()){
													$statement = "vyroba_osadzanie_smd_zaznamy".$statement_part_a;
												}
												else{
													$statement = "vyroba_osadzanie_smd_zaznamy WHERE autor=".$_SESSION['user_id'].$statement_part_b;
												}
