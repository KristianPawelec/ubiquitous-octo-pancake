...
function insert_work(){
    ...
    $insert_work_query="INSERT INTO udrzba_strojov(os_c, action_type, machine, kontakt, q, vp, tahova, vyhovuje, action_type_other, poznamka, datum, cas, druh) VALUES(".$_POST['os_c'].", ".$_POST['action_type'].", ".$_POST['machine'].", '".$_POST['kontakt']."', '".$_POST['q']."', '".$_POST['vp']."', '".$_POST['tahova']."', ".$_POST['vyhovuje'].", ".$_POST['action_type_other'].", '".$_POST['note']."', '".date('d-m-y')."', '".$_POST['time']."','".implode(",", $_POST['druh'])."')";
